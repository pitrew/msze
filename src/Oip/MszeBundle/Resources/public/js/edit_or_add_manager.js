...
$.oip.managerDef = function(city_id, district_id, church_id, fn) {
    var fun_city_select = fn["fun_city_select"],
        ...
        _local_show_hide_save = function() {
            if (
                    ...
                    (_district.id >= 0 && _district.cur_name != _district.cur_name) || //name change
                    ...
                    (_church.id >= 0 && _mass.del_list.length > 0) || //something to delete
                    (_church.id >= 0 && _mass.mod_list.length > 0) || //something to mod or add
                    false
                )
            {
                fun_show_save();
    ...
    self.Save = function(re_c, re_r) {
        var str = { 'cid': _city.id, 'cname': _city.new_name, 
                ...
                'clat': _church.new_pos.lat,
                'clng': _church.new_pos.lng,
                'mmod': _mass.mod_list,
                'mdel': _mass.del_list
              };
