...
class MobileController extends Controller
{
    public function versionAction() {
		return $this->redirect('http://msze.esy.es/mobile/version', 301);
/*        $vrepo = $this->getDoctrine()->getRepository('OipMszeBundle:Version');
    ...
    public function countAction() {
		return $this->redirect('http://msze.esy.es/mobile/count', 301);
		/*
	...
	public function updateAction($from, $to, $_format) {

		return $this->redirect('http://msze.esy.es/mobile/update/' . $from . '/' . $to . '.' . $_format, 301);
